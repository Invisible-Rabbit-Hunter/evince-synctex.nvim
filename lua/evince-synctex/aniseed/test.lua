...
local _0_0
do
  local name_0_ = "evince-synctex.aniseed.test"
  local module_0_
  do
...
local function _1_(...)
  ...
  local function _1_()
    return {autoload("evince-synctex.aniseed.core"), autoload("evince-synctex.aniseed.nvim"), autoload("evince-synctex.aniseed.string")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {autoload = {a = "evince-synctex.aniseed.core", nvim = "evince-synctex.aniseed.nvim", str = "evince-synctex.aniseed.string"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "evince-synctex.aniseed.test"
