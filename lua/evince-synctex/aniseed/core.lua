...
local _0_0
do
  local name_0_ = "evince-synctex.aniseed.core"
  local module_0_
  do
...
local function _1_(...)
  ...
  local function _1_()
    return {autoload("evince-synctex.aniseed.view")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {autoload = {view = "evince-synctex.aniseed.view"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "evince-synctex.aniseed.core"
