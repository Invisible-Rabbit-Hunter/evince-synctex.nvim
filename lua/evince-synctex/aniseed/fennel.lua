...
local _0_0
do
  local name_0_ = "evince-synctex.aniseed.fennel"
  local module_0_
  do
...
local function _1_(...)
  ...
  local function _1_()
    return {autoload("evince-synctex.aniseed.nvim")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {autoload = {nvim = "evince-synctex.aniseed.nvim"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "evince-synctex.aniseed.fennel"
...
do
  ...
  do
    local v_0_0
    local function _2_()
      return require("evince-synctex.aniseed.deps.fennel")
    end
    v_0_0 = _2_
    _0_0["impl"] = v_0_0
    v_0_ = v_0_0
