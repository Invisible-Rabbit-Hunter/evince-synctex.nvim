...
local _0_0
do
  local name_0_ = "evince-synctex.aniseed.env"
  local module_0_
  do
...
local function _1_(...)
  ...
  local function _1_()
    return {autoload("evince-synctex.aniseed.compile"), autoload("evince-synctex.aniseed.fennel"), autoload("evince-synctex.aniseed.fs"), autoload("evince-synctex.aniseed.nvim")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {autoload = {compile = "evince-synctex.aniseed.compile", fennel = "evince-synctex.aniseed.fennel", fs = "evince-synctex.aniseed.fs", nvim = "evince-synctex.aniseed.nvim"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "evince-synctex.aniseed.env"
